...
class DatabaseService {
  ...
  Future<void> _ensureLocalFirstSchema(Transaction txn) async {
    await _ensureColumn(txn, 'story_locations', 'setting_type', "TEXT NOT NULL DEFAULT 'INT'");
    await _ensureColumn(txn, 'story_locations', 'time_of_day', "TEXT NOT NULL DEFAULT 'DAY'");
