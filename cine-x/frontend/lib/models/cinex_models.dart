...
class StoryLocation {
  ...
  String get settingType => 'INT';
  String get timeOfDay => 'DAY';
...
class Scene {
  ...
  String get sceneHeading {
    final setting = switch (settingType) {
      'INT' => 'Nội cảnh',
      'EXT' => 'Ngoại cảnh',
      _ => settingType,
    };
    final time = switch (timeOfDay) {
      'DAY' => 'Ngày',
      'NIGHT' => 'Đêm',
      _ => timeOfDay,
    };
    return 'Cảnh $sceneNumber: $setting. $storyLocationName - $time';
  }
