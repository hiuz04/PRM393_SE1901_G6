...
public class AnalyticsService {
    ...
    public LocationSettingRatioResponse locationSettingRatio(Long projectId) {
        ...
        sceneRepository.findByProjectIdOrderBySceneNumberAsc(projectId)
                .forEach(scene -> {
                    if (scene.getLocation() != null && scene.getLocation().getSettingType() != null) {
                        SettingType type = scene.getLocation().getSettingType();
